...
const corsOptions = {
  origin: ['http://localhost:3000', 'http://localhost:3001', 'http://localhost:5000', 'https://vervex-c5b91.web.app', 'https://vervex-app.com', 'https://lutz1.github.io', 'https://vervexofficial.online'],
  credentials: true,
